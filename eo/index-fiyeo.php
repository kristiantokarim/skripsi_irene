	...
	<head>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="img/irene/wedding-rings.png" alt="">
								</a>
								<p>Wedding</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="img/irene/birthday-cake.png" alt="">
								</a>
								<p>Birthday</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="img/irene/wine-glasses.png" alt="">
								</a>
								<p>Private Party</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="img/irene/microphone.png" alt="">
								</a>
								<p>Entertainment</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								<a href="category.html">
									<img src="img/irene/meeting.png" alt="">
								</a>
								<p>MICE</p>
							</div>
						</div>
        ...
        <img class ="d-block w-100" src="img/13792.jpg" alt="First" style="width: 100%; height: 300px">
        </div>
					...
					<div class="row justify-content-center d-flex">
						...
						<div class="menu-content pb-50 col-lg-10">
							...
							<div class="single-post d-flex flex-row">
								...
								<div class="titles">
								<a href="eo-frontend.php"><h4>Excellent Event</h4></a>
                                </div>
									</div>
                                    <p style="color: #aa80ff">
                                    <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                                    </p>
									<p>
										Event & Party Organizer in Jakarta
									</p>
									<p class="address"><span class="fa fa-map-o"></span>&nbsp; Jakarta Barat, DKI Jakarta</p>
